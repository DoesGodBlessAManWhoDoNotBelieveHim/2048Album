...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions
{
    ...
    /*  等同上方法
    NSDictionary *fistLaunchSettings = [NSDictionary dictionaryWithObjectsAndKeys:[NSNumber numberWithInteger:0],kBestScore, [NSNumber numberWithBool:YES],kEffectSoundEnable,nil];
    [[NSUserDefaults standardUserDefaults]registerDefaults:fistLaunchSettings];
    */
    
    
    //MenuTableViewController * leftSideDrawerViewController = [storyBoard instantiateViewControllerWithIdentifier:@"MenuTableViewController"];
...
#pragma mark - 
    ...
    //leveyTabBarController = [storyBoard instantiateViewControllerWithIdentifier:@"LeveyTabBarController"];
